...
var UserClass = /** @class */ (function () {
    ...
    UserClass.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userCredentials, email, password, singUser, validatePassword, name_1, createdAt, _id, ban, payload, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        name_1 = singUser.name, createdAt = singUser.createdAt, _id = singUser._id, ban = singUser.ban;
                        payload = {
                            email: email,
                            name: name_1,
                            ban: ban,
    ...
    UserClass.prototype.register = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var salt, hashedPassword, savedUser, _a, email, name_2, createdAt, _id, ban, payload, token, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        savedUser = _b.sent();
                        _a = savedUser.response, email = _a.email, name_2 = _a.name, createdAt = _a.createdAt, _id = _a._id, ban = _a.ban;
                        payload = {
                            email: email,
                            name: name_2,
                            ban: ban,
